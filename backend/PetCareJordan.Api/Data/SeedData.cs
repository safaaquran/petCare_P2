...
public static class SeedData
{
    public static async Task InitializeAsync(PetCareJordanContext context)
    {
        ...
        var pets = new List<Pet>
        {
            ...
            new() { Name = "Bella", Type = PetType.Dog, Breed = "Golden Retriever", AgeInMonths = 30, Gender = PetGender.Female, CollarId = "PCJ-1002", Color = "Golden", City = "Amman", WeightKg = 22.4m, IsNeutered = false, Description = "Friendly and perfect with children.", PhotoUrl = "https://images.unsplash.com/photo-1517849845537-4d257902454a", OwnerId = userByEmail["yousef@petcare.jo"].Id },
            new() { Name = "Kiwi", Type = PetType.Bird, Breed = "Cockatiel", AgeInMonths = 10, Gender = PetGender.Female, CollarId = "PCJ-1003", Color = "Grey and yellow", City = "Irbid", WeightKg = 0.1m, IsNeutered = false, Description = "Social bird that whistles a lot.", PhotoUrl = "https://images.unsplash.com/photo-1444464666168-49d633b86797", OwnerId = userByEmail["sara@petcare.jo"].Id },
            ...
            new() { Name = "Nala", Type = PetType.Dog, Breed = "Husky", AgeInMonths = 28, Gender = PetGender.Female, CollarId = "PCJ-1009", Color = "Grey and white", City = "Jerash", WeightKg = 20.2m, IsNeutered = true, Description = "Energetic dog that enjoys long walks.", PhotoUrl = "https://images.unsplash.com/photo-1548199973-03cce0bbc87b", OwnerId = userByEmail["yousef@petcare.jo"].Id },
            new() { Name = "Hazel", Type = PetType.Rabbit, Breed = "Mini Rex", AgeInMonths = 9, Gender = PetGender.Female, CollarId = "PCJ-1010", Color = "Brown", City = "Amman", WeightKg = 1.4m, IsNeutered = false, Description = "Curious rabbit with a calm personality.", PhotoUrl = "https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308", OwnerId = userByEmail["sara@petcare.jo"].Id },
            ...
            new() { Name = "Poppy", Type = PetType.Cat, Breed = "Scottish Fold", AgeInMonths = 20, Gender = PetGender.Female, CollarId = "PCJ-1012", Color = "Silver", City = "Irbid", WeightKg = 4.0m, IsNeutered = true, Description = "Quiet cat that likes window naps.", PhotoUrl = "https://images.unsplash.com/photo-1519052537078-e6302a4968d4", OwnerId = userByEmail["ahmad@petcare.jo"].Id },
            new() { Name = "Max", Type = PetType.Dog, Breed = "Mixed Breed", AgeInMonths = 14, Gender = PetGender.Male, CollarId = "PCJ-1013", Color = "Brown and white", City = "Zarqa", WeightKg = 11.5m, IsNeutered = true, Description = "Rescued dog ready for a second chance.", PhotoUrl = "https://images.unsplash.com/photo-1507146426996-ef05306b995a", OwnerId = userByEmail["rama@petcare.jo"].Id },
            new() { Name = "Ruby", Type = PetType.Other, Breed = "Hamster", AgeInMonths = 6, Gender = PetGender.Female, CollarId = "PCJ-1014", Color = "Golden", City = "Salt", WeightKg = 0.05m, IsNeutered = false, Description = "Small and easy to care for.", PhotoUrl = "https://images.unsplash.com/photo-1425082661705-1834bfd09dca", OwnerId = userByEmail["tareq@petcare.jo"].Id },
            new() { Name = "Leo", Type = PetType.Cat, Breed = "Orange Tabby", AgeInMonths = 15, Gender = PetGender.Male, CollarId = "PCJ-1015", Color = "Orange", City = "Amman", WeightKg = 4.6m, IsNeutered = true, Description = "Curious and social cat.", PhotoUrl = "https://images.unsplash.com/photo-1543852786-1cf6624b9987", OwnerId = userByEmail["lina@petcare.jo"].Id },
            new() { Name = "Lemon", Type = PetType.Bird, Breed = "Canary", AgeInMonths = 8, Gender = PetGender.Female, CollarId = "PCJ-1016", Color = "Yellow", City = "Madaba", WeightKg = 0.03m, IsNeutered = false, Description = "Beautiful singer for a calm home.", PhotoUrl = "https://images.unsplash.com/photo-1520808663317-647b476a81b9", OwnerId = userByEmail["yousef@petcare.jo"].Id },
            new() { Name = "Bruno", Type = PetType.Dog, Breed = "Boxer", AgeInMonths = 26, Gender = PetGender.Male, CollarId = "PCJ-1017", Color = "Brown", City = "Irbid", WeightKg = 24.2m, IsNeutered = false, Description = "Protective, smart, and playful.", PhotoUrl = "https://images.unsplash.com/photo-1517423440428-a5a00ad493e8", OwnerId = userByEmail["sara@petcare.jo"].Id },
